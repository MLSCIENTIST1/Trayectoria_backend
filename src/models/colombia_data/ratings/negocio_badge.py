...
BADGES_INICIALES = [
    ...
    # ═══ SOCIAL · SEGUIDORES (interacciones reales: negocio_interacciones tipo='seguir') ═══
    {
        "codigo": "primer_seguidor", "nombre": "Primer Seguidor",
        "descripcion": "Conseguiste tu primer seguidor — ¡alguien cree en tu tienda!",
        "icono": "bi-person-plus-fill", "color_primario": "#10b981",
        "color_fondo": "rgba(16,185,129,0.15)", "categoria": "popularidad",
        "nivel": 1, "puntos": 15,
        "criterio_tipo": "seguidores", "criterio_valor": 1, "criterio_operador": ">=",
    },
    {
        "codigo": "comunidad_fiel", "nombre": "Comunidad Fiel",
        "descripcion": "25 personas siguen tu tienda",
        "icono": "bi-people-fill", "color_primario": "#3b82f6",
        "color_fondo": "rgba(59,130,246,0.15)", "categoria": "popularidad",
        "nivel": 2, "puntos": 35,
        "criterio_tipo": "seguidores", "criterio_valor": 25, "criterio_operador": ">=",
    },
    {
        "codigo": "influencer_local", "nombre": "Influencer Local",
        "descripcion": "100 seguidores — tu negocio ya es referente del barrio",
        "icono": "bi-megaphone-fill", "color_primario": "#8b5cf6",
        "color_fondo": "rgba(139,92,246,0.15)", "categoria": "popularidad",
        "nivel": 3, "puntos": 60,
        "criterio_tipo": "seguidores", "criterio_valor": 100, "criterio_operador": ">=",
    },
    {
        "codigo": "celebridad", "nombre": "Celebridad",
        "descripcion": "500 seguidores — ¡eres toda una celebridad!",
        "icono": "bi-stars", "color_primario": "#f59e0b",
        "color_fondo": "rgba(245,158,11,0.15)", "categoria": "popularidad",
        "nivel": 4, "puntos": 110,
        "criterio_tipo": "seguidores", "criterio_valor": 500, "criterio_operador": ">=",
    },
    {
        "codigo": "idolo_de_masas", "nombre": "Ídolo de Masas",
        "descripcion": "1.000 seguidores — un fenómeno imparable",
        "icono": "bi-gem", "color_primario": "#a855f7",
        "color_fondo": "rgba(168,85,247,0.18)",
        "gradiente": "linear-gradient(135deg, #c084fc 0%, #a855f7 50%, #6366f1 100%)",
        "categoria": "popularidad",
        "nivel": 5, "puntos": 200,
        "criterio_tipo": "seguidores", "criterio_valor": 1000, "criterio_operador": ">=",
    },

    # ═══ SOCIAL · ME GUSTA (interacciones reales: negocio_interacciones tipo='like') ═══
    {
        "codigo": "primer_like", "nombre": "Primer Me Gusta",
        "descripcion": "Recibiste tu primer me gusta — ¡gustas!",
        "icono": "bi-hand-thumbs-up-fill", "color_primario": "#10b981",
        "color_fondo": "rgba(16,185,129,0.15)", "categoria": "popularidad",
        "nivel": 1, "puntos": 10,
        "criterio_tipo": "me_gusta", "criterio_valor": 1, "criterio_operador": ">=",
    },
    {
        "codigo": "gustando", "nombre": "Gustando",
        "descripcion": "50 me gusta en tu tienda",
        "icono": "bi-heart-fill", "color_primario": "#ec4899",
        "color_fondo": "rgba(236,72,153,0.15)", "categoria": "popularidad",
        "nivel": 2, "puntos": 25,
        "criterio_tipo": "me_gusta", "criterio_valor": 50, "criterio_operador": ">=",
    },
    {
        "codigo": "muy_querido", "nombre": "Muy Querido",
        "descripcion": "200 me gusta — la gente te quiere",
        "icono": "bi-heart-pulse-fill", "color_primario": "#f43f5e",
        "color_fondo": "rgba(244,63,94,0.15)", "categoria": "popularidad",
        "nivel": 2, "puntos": 40,
        "criterio_tipo": "me_gusta", "criterio_valor": 200, "criterio_operador": ">=",
    },
    {
        "codigo": "favorito_barrio", "nombre": "Favorito del Barrio",
        "descripcion": "500 me gusta — eres el favorito de la zona",
        "icono": "bi-hearts", "color_primario": "#e11d48",
        "color_fondo": "rgba(225,29,72,0.15)", "categoria": "popularidad",
        "nivel": 3, "puntos": 70,
        "criterio_tipo": "me_gusta", "criterio_valor": 500, "criterio_operador": ">=",
    },
    {
        "codigo": "sensacion_viral", "nombre": "¡Sensación Viral!",
        "descripcion": "1.000 me gusta — tu tienda se volvió viral",
        "icono": "bi-fire", "color_primario": "#f97316",
        "color_fondo": "rgba(249,115,22,0.16)",
        "gradiente": "linear-gradient(135deg, #fb923c 0%, #f97316 50%, #ef4444 100%)",
        "categoria": "popularidad",
        "nivel": 4, "puntos": 120,
        "criterio_tipo": "me_gusta", "criterio_valor": 1000, "criterio_operador": ">=",
    },
    {
        "codigo": "fenomeno_total", "nombre": "Fenómeno Total",
        "descripcion": "5.000 me gusta — un fenómeno absoluto",
        "icono": "bi-lightning-charge-fill", "color_primario": "#06b6d4",
        "color_fondo": "rgba(6,182,212,0.16)",
        "gradiente": "linear-gradient(135deg, #22d3ee 0%, #06b6d4 50%, #3b82f6 100%)",
        "categoria": "popularidad",
        "nivel": 5, "puntos": 220,
        "criterio_tipo": "me_gusta", "criterio_valor": 5000, "criterio_operador": ">=",
    },
    {
        "codigo": "leyenda_imparable", "nombre": "Leyenda Imparable",
        "descripcion": "10.000 me gusta — entraste en la leyenda de TuKomercio",
        "icono": "bi-trophy-fill", "color_primario": "#fbbf24",
        "color_fondo": "rgba(251,191,36,0.20)",
        "gradiente": "linear-gradient(135deg, #fde68a 0%, #fbbf24 30%, #f97316 60%, #a855f7 100%)",
        "categoria": "popularidad",
        "nivel": 5, "puntos": 350,
        "criterio_tipo": "me_gusta", "criterio_valor": 10000, "criterio_operador": ">=",
    },
