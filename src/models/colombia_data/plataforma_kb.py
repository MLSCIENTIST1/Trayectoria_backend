...
SEED_KB = [
    ...
    # ── Novedades nuevas (publicadas) — features ya construidos no anunciados ──
    {'tipo': 'changelog', 'area': 'novedades', 'clave': 'cl-2026-06-centro-ayuda', 'publicado': True, 'titulo': 'Nuevo Centro de Ayuda', 'resumen': 'Guías paso a paso, buscador y novedades en tukomercio.co/ayuda.', 'datos': {'tipo': 'nuevo', 'fecha': '2026-06', 'version': '2.22'}, 'orden': -6},
    {'tipo': 'changelog', 'area': 'novedades', 'clave': 'cl-2026-06-social', 'publicado': True, 'titulo': 'Tus clientes pueden seguirte y dar Me gusta', 'resumen': 'Botones de Seguir 👥 y Me gusta ❤️ en tu tienda, con tu número de seguidores visible.', 'datos': {'tipo': 'nuevo', 'fecha': '2026-06', 'version': '2.21'}, 'orden': -5},
    {'tipo': 'changelog', 'area': 'novedades', 'clave': 'cl-2026-06-confianza', 'publicado': True, 'titulo': 'Sello de confianza en tu tienda', 'resumen': 'Verificado, calificación, pedidos entregados, seguidores y antigüedad, ahora en todas las plantillas.', 'datos': {'tipo': 'mejora', 'fecha': '2026-06', 'version': '2.21'}, 'orden': -4},
    {'tipo': 'changelog', 'area': 'novedades', 'clave': 'cl-2026-06-diseno', 'publicado': True, 'titulo': 'Renovamos el diseño', 'resumen': 'Una imagen más profesional y consistente en toda la plataforma.', 'datos': {'tipo': 'mejora', 'fecha': '2026-06', 'version': '2.22'}, 'orden': -3},
    {'tipo': 'changelog', 'area': 'novedades', 'clave': 'cl-2026-06-app', 'publicado': True, 'titulo': 'Instala TuKomercio como app, mejorado', 'resumen': 'Mejor ícono, pantalla de inicio más rápida y guía para instalar en iPhone.', 'datos': {'tipo': 'mejora', 'fecha': '2026-06', 'version': '2.22'}, 'orden': -2},
    {'tipo': 'changelog', 'area': 'novedades', 'clave': 'cl-2026-06-insignias-tienda', 'publicado': True, 'titulo': 'Tus insignias se lucen en tu tienda', 'resumen': 'Las insignias que ganaste ahora se ven como medallas junto al nombre de tu tienda, claras y con tu color, en vez de simples círculos.', 'datos': {'tipo': 'mejora', 'fecha': '2026-06', 'version': '2.22'}, 'orden': -7},
    {'tipo': 'changelog', 'area': 'novedades', 'clave': 'cl-2026-06-preview-vivo', 'publicado': True, 'titulo': 'Edita tu tienda y ve los cambios al instante', 'resumen': 'El Diseñador ahora muestra tu tienda real en vivo: cambias un color, un texto o el menú y lo ves al momento, tal como lo verán tus clientes.', 'datos': {'tipo': 'nuevo', 'fecha': '2026-06', 'version': '2.22'}, 'orden': -10},
    {'tipo': 'changelog', 'area': 'novedades', 'clave': 'cl-2026-06-slider', 'publicado': True, 'titulo': 'Personaliza el carrusel de tu tienda', 'resumen': 'Elige el tamaño (pequeño, mediano o grande) y la forma de los bordes (cuadrado o redondeado) del carrusel de imágenes principal.', 'datos': {'tipo': 'nuevo', 'fecha': '2026-06', 'version': '2.22'}, 'orden': -9},
    {'tipo': 'changelog', 'area': 'novedades', 'clave': 'cl-2026-06-posicion-social', 'publicado': True, 'titulo': 'Decide dónde van Seguir, Me gusta e Insignias', 'resumen': 'Desde el Diseñador eliges si los botones de Seguir y Me gusta y tus insignias van arriba junto al buscador o abajo en la barra de confianza.', 'datos': {'tipo': 'nuevo', 'fecha': '2026-06', 'version': '2.22'}, 'orden': -8},
    {'tipo': 'changelog', 'area': 'novedades', 'clave': 'cl-2026-06-referidos', 'publicado': True, 'titulo': '¡Invita y gana! Comparte TuKomercio', 'resumen': 'Comparte tu link de invitación: cuando alguien que invitaste publica su tienda y paga su plan, ganas TuKoins que puedes usar para abonar tu propia mensualidad. Búscalo en "Invita y gana".', 'datos': {'tipo': 'nuevo', 'fecha': '2026-06', 'version': '2.23'}, 'orden': -14},
    {'tipo': 'changelog', 'area': 'novedades', 'clave': 'cl-2026-06-orden-productos', 'publicado': True, 'titulo': 'Elige en qué orden aparecen tus productos', 'resumen': 'Desde el Diseñador decides cómo se muestran tus productos al entrar a la tienda: más nuevos, más vendidos, más vistos, por precio, alfabético, destacados o aleatorio. Funciona en todas las plantillas.', 'datos': {'tipo': 'nuevo', 'fecha': '2026-06', 'version': '2.23'}, 'orden': -13},
    {'tipo': 'changelog', 'area': 'novedades', 'clave': 'cl-2026-06-precio-legible', 'publicado': True, 'titulo': 'El precio se ve bien con cualquier color', 'resumen': 'Si elegiste un color oscuro para tu tienda, el precio de tus productos ahora se ajusta solo para que siempre se lea con claridad, en todas las plantillas.', 'datos': {'tipo': 'mejora', 'fecha': '2026-06', 'version': '2.23'}, 'orden': -12},
    {'tipo': 'changelog', 'area': 'novedades', 'clave': 'cl-2026-06-ayuda-designer', 'publicado': True, 'titulo': 'Ayuda en cada parte del Diseñador', 'resumen': 'Cada sección del Diseñador tiene ahora un botón de ayuda (ℹ️) que explica para qué sirve y cómo aprovecharla. Diseñar tu tienda es más fácil que nunca.', 'datos': {'tipo': 'mejora', 'fecha': '2026-06', 'version': '2.23'}, 'orden': -11},
    {'tipo': 'changelog', 'area': 'novedades', 'clave': 'cl-2026-06-split-view', 'publicado': True, 'titulo': 'Trabaja con dos vistas a la vez (como los pro)', 'resumen': 'En el computador, divide tu pantalla y abre dos o tres módulos lado a lado: registra ventas mientras ves tu tienda o tus finanzas, sin cambiar de pestaña. Atajo: Ctrl + \\. (Disponible solo en escritorio.)', 'datos': {'tipo': 'nuevo', 'fecha': '2026-06', 'version': '2.24'}, 'orden': -15},
    {'tipo': 'changelog', 'area': 'novedades', 'clave': 'cl-2026-06-metricas-producto', 'publicado': True, 'titulo': 'Mira las métricas de cada producto', 'resumen': 'Desde Inventario, abre "Ver métricas" de un producto y descubre cuántas visitas tuvo, cuántas veces lo agregaron al carrito, cuántas ventas e ingresos generó y su tasa de conversión, con un gráfico de los últimos días. Así sabes qué productos empujar y a cuáles ajustarles el precio.', 'datos': {'tipo': 'nuevo', 'fecha': '2026-06', 'version': '2.24'}, 'orden': -16},
    {'tipo': 'changelog', 'area': 'novedades', 'clave': 'cl-2026-06-compartir-producto', 'publicado': True, 'titulo': 'Comparte un producto y aparece con su propia foto', 'resumen': 'Cuando compartes el enlace de un producto por WhatsApp o redes, la vista previa ahora muestra la foto, el nombre y el precio de ESE producto (antes salía la imagen general de la tienda). Funciona en todas las plantillas. El envío del resumen de pedido sigue igual.', 'datos': {'tipo': 'mejora', 'fecha': '2026-06', 'version': '2.24'}, 'orden': -17},
