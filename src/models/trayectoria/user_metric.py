...
class UserMetric(db.Model):
    ...
    metric_display = Column(String(50), nullable=True)
    
    # === INFORMACIÓN PARA UI ===
    metric_name = Column(String(100), nullable=False)
    metric_icon = Column(String(50), nullable=True)
    metric_color = Column(String(7), nullable=True)
    
    # === CAMBIO RECIENTE ===
    cambio_valor = Column(Float, nullable=True)
    cambio_texto = Column(String(50), nullable=True)
