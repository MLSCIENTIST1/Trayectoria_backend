...
from src.models.usuarios import Usuario  # Relación con el modelo Usuario
...
details_candidate_bp = Blueprint('details_candidate_bp', __name__)

@details_candidate_bp.route('/details', methods=['POST'])
@login_required
def rate_contratado(servicio_id):
    ...
    try:
        ...
        if not calificacion:
            ...
            calificacion.recived_contratado3 = cal3
