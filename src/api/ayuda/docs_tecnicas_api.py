...
SECCIONES_DOC = [
    {'area': 'glosario',     'titulo': 'Glosario (para no técnicos)', 'icono': 'bi-journal-bookmark-fill', 'orden': 0},
    ...
    {'area': 'backend',      'titulo': 'Backend (Flask)',       'icono': 'bi-cpu-fill', 'orden': 2},
    {'area': 'endpoints',    'titulo': 'Referencia de endpoints', 'icono': 'bi-sign-turn-right-fill', 'orden': 2},
    {'area': 'base-datos',   'titulo': 'Base de datos',         'icono': 'bi-database-fill-gear',  'orden': 3},
    {'area': 'frontend',     'titulo': 'Frontend',              'icono': 'bi-window-stack', 'orden': 4},
    {'area': 'diseno',       'titulo': 'Sistema visual y marca', 'icono': 'bi-palette-fill', 'orden': 4},
    {'area': 'auth',         'titulo': 'Autenticación y sesiones', 'icono': 'bi-shield-lock-fill', 'orden': 5},
    {'area': 'panel',        'titulo': 'Panel de administración', 'icono': 'bi-ui-checks-grid', 'orden': 6},
    ...
    {'area': 'integraciones','titulo': 'Integraciones',         'icono': 'bi-puzzle-fill', 'orden': 9},
    {'area': 'seguridad',    'titulo': 'Seguridad',             'icono': 'bi-shield-fill-check', 'orden': 10},
    {'area': 'despliegue',   'titulo': 'Despliegue / DevOps',   'icono': 'bi-rocket-takeoff-fill', 'orden': 11},
    {'area': 'operacion',    'titulo': 'Operación',             'icono': 'bi-gear-fill', 'orden': 12},
    {'area': 'ui-map',       'titulo': 'Mapa de UI / botones',  'icono': 'bi-grid-1x2-fill', 'orden': 13},
    {'area': 'negocio',      'titulo': 'Negocio y planes',      'icono': 'bi-graph-up-arrow', 'orden': 14},
    {'area': 'flujos',       'titulo': 'Flujos de datos',       'icono': 'bi-diagram-2-fill', 'orden': 15},
    {'area': 'errores',      'titulo': 'Errores y respuestas',  'icono': 'bi-exclamation-octagon-fill', 'orden': 16},
    {'area': 'terceros',     'titulo': 'Servicios de terceros', 'icono': 'bi-box-seam-fill', 'orden': 17},
    {'area': 'respaldo',     'titulo': 'Respaldo y recuperación', 'icono': 'bi-cloud-arrow-down-fill', 'orden': 18},
    {'area': 'pruebas',      'titulo': 'Pruebas (tests)',       'icono': 'bi-clipboard2-check-fill', 'orden': 19},
    {'area': 'handover',     'titulo': 'Entrega / onboarding',  'icono': 'bi-box-arrow-in-right', 'orden': 20},
    {'area': 'legal',        'titulo': 'Propiedad y confidencialidad', 'icono': 'bi-file-earmark-lock2-fill', 'orden': 21},
]
