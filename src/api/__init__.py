...
def register_api(app):
    ...
    # Centro de Ayuda — CRUD admin (panel)
    if safe_register('src.api.ayuda.centro_ayuda_admin_api', 'centro_ayuda_admin_bp', 'Centro de Ayuda Admin', prefix=None):
        success_count += 1
    else:
        fail_count += 1
    ...
    if safe_register('src.api.tiendas.pedidos_api', 'tiendas_pedidos_bp', 'Gestión de Pedidos (Tiendas)', prefix=None):
        success_count += 1
    else:
        fail_count += 1
